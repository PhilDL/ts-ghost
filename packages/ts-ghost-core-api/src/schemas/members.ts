...
// 'email', 'name', 'note', 'subscribed', 'geolocation', 'created_at', 'products', 'newsletters'
export const membersCreateSchema = z.array(
  z.object({
    ...
    subscribed: z
      .boolean({
        description: "Will subscribe the user to the default Newsletter, incompatible with the `newsletters` property",
      })
      .nullish(),
