...
describe("posts integration tests browse", () => {
  ...
  test("posts.read() with non-existent id returns 422 status ValidationError", async () => {
  ...
  test("posts.read() with non-existent slug returns 404 status NotFoundError", async () => {
