...
export default function PackageDocsLayout(props: { children: ReactNode }) {
  const navigation = siteConfig.docs.find((item) => item.path === "/docs/ghost-blog-buster")?.navigation;
  if (!navigation) throw new Error("No navigation found for /docs/ghost-blog-buster");
  return (
    <>
